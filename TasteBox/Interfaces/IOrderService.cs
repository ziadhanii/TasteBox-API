...
public interface IOrderService
{
    ...
    Task<Result<OrderTrackingResponse>> GetOrderTrackingAsync(
        string userId,
        int orderId,
        CancellationToken cancellationToken = default);

    Task<Result<OrderResponse>> GetOrderByIdAsync(string userId, int orderId,
        CancellationToken cancellationToken = default);

    Task<Result<IEnumerable<OrderSummaryResponse>>> GetUserOrdersAsync(string userId,
        CancellationToken cancellationToken = default);
